...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const data: EventData[] = [
      ...
      },
      {
        ...
        description:
          'The World Wide Web was launched to the public, making the Internet accessible globally.',
        imageURL:
      ...
      },
      {
        ...
        imageURL:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgFvP-k4i2t-cpPjdj1PretSNShzwnMiNtVg&s',
        category: 'Mobile',
      },
      ...
      
      {
        ...
        description:
          'Instagram was launched, changing social media and photo sharing.',
        imageURL:
      ...
      },
      {
        ...
        title: 'Rise of AI',
        description:
          'Artificial Intelligence technologies started booming across industries.',
        imageURL:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToQFiYOgyUO1xx2z7umpczwvmIa5nIQLmQbw&s',
        category: 'Technology',
      },
    ];
    setEvents(data);
  ...
  return (
    <div className={`app-container ${isDark ? 'dark' : 'light'}`}>
      ...
      <Timeline events={events} selectedEvent={selectedEvent} onSelectEvent={setSelectedEvent} />
      {selectedEvent && (
